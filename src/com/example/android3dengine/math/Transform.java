...
public class Transform {
	...
	private static float zNear; // Near clipping
	private static float zFar; // Far clipping
	...
	public Matrix4f getTransformation() {
		...
		// Apply scale first, then rotate, and translate
		return translationMatrix.mul(rotationMatrix.mul(scaleMatrix));
	}

	/**
	 * Orthographic projection to perspective projection.
	 *
	 * @return A getTransformation() applied with projection transformation.
	 */
